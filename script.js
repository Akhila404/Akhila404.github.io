...
C4Key.addEventListener("click", platC4);
...
Db4Key.addEventListener("click", platDb4);
...
D4Key.addEventListener("click", platD4);
...
Eb4Key.addEventListener("click", platEb4);
...
E4Key.addEventListener("click", platE4);
...
F4Key.addEventListener("click", platF4);
...
Gb4Key.addEventListener("click", platGb4);
...
G4Key.addEventListener("click", platG4);
...
Ab4Key.addEventListener("click", platAb4);
...
A4Key.addEventListener("click", platA4);
...
Bb4Key.addEventListener("click", platBb4);
...
B4Key.addEventListener("click", platB4);
...
C5Key.addEventListener("click", platC5);
...
Db5Key.addEventListener("click", platDb5);
...
D5Key.addEventListener("click", platD5);
...
Eb5Key.addEventListener("click", platEb5);
...
E5Key.addEventListener("click", platE5);
